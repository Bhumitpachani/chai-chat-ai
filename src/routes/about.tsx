  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 md:py-24">
        <p className="text-xs uppercase tracking-widest text-primary sm:text-sm">About</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 md:mt-12 md:gap-5">
          {[
            ...
            <div key={f.title} className="card-3d p-5 sm:p-6">
              <div className="grid h-10 w-10 place-items-center rounded-xl btn-hero sm:h-11 sm:w-11">
        ...
        <div className="card-3d mt-10 p-6 md:mt-12 md:p-8">
          <h2 className="font-display text-xl font-semibold sm:text-2xl">How it works</h2>
          <ol className="mt-5 space-y-4 text-sm text-muted-foreground">
            <li><span className="font-medium text-foreground">1. Tell us your name.</span> Just a first name is enough — we save it locally on your device.</li>
            <li><span className="font-medium text-foreground">2. Get matched.</span> We pair you with a friendly companion. Every session is unique.</li>
            <li><span className="font-medium text-foreground">3. Chat freely.</span> Talk about your day, hobbies, dreams — anything. End the chat whenever you want.</li>
          </ol>
          <Link to="/chat" className="mt-6 inline-flex w-full justify-center rounded-full px-6 py-3 text-sm font-medium btn-hero sm:mt-7 sm:w-auto sm:justify-start">
